    ...
    return(
        ...
        <div className=" max-w-[1200px] sm:flex sm:flex-wrap">
                <Link href='./izeus/faixa' className="" >
                    <Card className='h-[180px] max-w-[350px] sm:mr-3 sm:mb-3 sm:mt-4 sm:hover:-translate-y-3 sm:transition-transform sm:duration-300'>
                        <CardHeader>
                ...
                <Link href='./izeus/req_extra' className="" >
                    <Card className='h-[180px] max-w-[350px] sm:mr-3 mt-4 sm:mt-4 mb-3 sm:mb-0 sm:hover:-translate-y-3 sm:transition-transform sm:duration-300'>
                        <CardHeader>
                            <div className="flex mb-2">
                                <PencilLine className="mr-3" size={30}></PencilLine>
